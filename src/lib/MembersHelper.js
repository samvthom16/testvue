...
const membershelper = (style = 'ListWithImage', event_id = 0) => {
  ...
  const selectDropdownItem = (data) => {
    ...
    if (data.name == 'group' && data.value == 'all') params.value.group = ''
    if (data.name == 'gender' && data.value == 'all') params.value.gender = ''
    if (data.name == 'location' && data.value == 'all') params.value.location = ''
    if (data.name == 'profession' && data.value == 'all') params.value.profession = ''
