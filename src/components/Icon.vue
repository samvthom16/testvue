<template>
  ...
  <svg
    ...
    v-bind="$attrs"
    xmlns="http://www.w3.org/2000/svg" class="" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
  </svg>
  <svg
    v-else-if="type == 'Right-Arrow'"
    v-bind="$attrs"
    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#aaa" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
  </svg>
  <svg
    v-else-if="type == 'Single-User'"
    v-bind="$attrs"
    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2">
...
<svg
  ...
  <svg
    v-else-if="type == 'EllipsisVertical'"
    v-bind="$attrs"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 15.5A3.5 3.5 0 0 1 8.5 12 3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5 3.5 3.5 0 0 1-3.5 3.5m7.43-2.92c.04-.34.07-.69.07-1.08s-.03-.73-.07-1.08l2.32-1.81c.21-.16.27-.46.13-.71l-2.2-3.8c-.13-.26-.43-.34-.69-.26l-2.74 1.1c-.57-.44-1.18-.81-1.85-1.09l-.41-2.9C14.24 2.24 13.95 2 13.6 2h-4.4c-.35 0-.64.24-.68.56l-.41 2.9c-.67.28-1.28.65-1.85 1.09l-2.74-1.1c-.26-.09-.56 0-.69.26l-2.2 3.8c-.14.25-.08.55.13.71l2.32 1.81C3.03 11.27 3 11.62 3 12s.03.73.07 1.08l-2.32 1.81c-.21.16-.27.46-.13.71l2.2 3.8c.13.26.43.34.69.26l2.74-1.1c.57.44 1.18.81 1.85 1.09l.41 2.9c.04.32.33.56.68.56h4.4c.35 0 .64-.24.68-.56l.41-2.9c.67-.28 1.28-.65 1.85-1.09l2.74 1.1c.26.09.56 0 .69-.26l2.2-3.8c.14-.25.08-.55-.13-.71l-2.32-1.81z" />
  </svg>
</template>
<script>
export default {
