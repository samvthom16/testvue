  ...
  <div class='modal-container'>
    ...
    <Transition name='slideup'>
      <div class="modal" role="dialog" aria-labelledby="modalTitle" aria-describedby="modalDescription" v-if='showModal'>
        <header class="modal-header p-3 border-b border-lightgray" id="modalTitle">
          <slot name='modaltitle'></slot>
          <button class="btn-close" @click="close" aria-label="Close modal">&times;</button>
        </header>
        <section class="modal-body p-3" id="modalDescription">
...
<style>
  ...
  .modal{
    @apply w-full bg-white bottom-0 max-w-4xl left-1/2 rounded-t-lg;
